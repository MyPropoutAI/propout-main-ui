    ...
    <section>
          ...
          <Row>
            ...
            <Col md={7} className="home-header">
              <h1 className="heading-name">
                The Decentralized Real Estate Marketplace and Network
                Technology!
              </h1>
              <p className="heading-paragraph">List Properties on the goo...</p>
              <div className="buttons">
                <Button title="List" className="butto" />
                <TransparentButton title="Rent" className="butto" />
                <TransparentButton title="Buy" className="butto" />
                {/* <TransparentButton
                    title="P2P"
                    className="butto"
                  /> */}
      ...
      <Container fluid className="home-section" id="home">
        <Col md={12} className="ourServices">
          ...
          <p className="sub-header">
            ...
            property assets remotely. Open participation for all kinds of users
            with the following in-built AI tech integrations to foster trust,
            transperency, and convenience.
          </p>
        </Col>
        <Row className="row">
          <Col md={6}>
            <img src={bestServices} alt="home pic" className="imageBg" />
          </Col>
          <Col md={6}>
      ...
      <Container fluid className="home-section" id="home">
        ...
        <Row className="row">
          ...
          <Col md={6}>
            <img src={benefits} alt="picture" className="imageBg" />
          </Col>
        </Row>
      </Container>
